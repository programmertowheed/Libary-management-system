...
<head>
	...
	<title>Login | Libary managment system</title>
		...
		<div class="row">
			<div class="lfrom-inner">
				<?php
					if(isset($_REQUEST['submit']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
						...
						if(empty($email) || empty($password)){
							...
							$query = "SELECT * FROM tbl_user WHERE userEmail='$email' && userPass='$userpass' && auth='$auth' ";
				...
				<form action="login.php" method="post">
					<h4 class="log-text text-center mb-4">Administrator Log In</h4>
